...
//--Ver
int copy_l(Lista* l){
    return l->cur->vipd; //Devuelve valor
};
...
//--Reset
int reset_l(Lista* l){
    l->cur = l->acc; //Cursor y aux apuntan al primer elemento
    l->aux = l->acc;
    return 1;
};

//--Forward
int forward_l(Lista *l){
