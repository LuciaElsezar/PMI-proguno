...
do{
	...
	break;
		case 2:
			ingresar_int(&mes, 11,12, "Ingrese el mes", "Error. Mes no valido. Reintente");
	...
	break;
		case 7:
			...
			scanf("%ld", &dni);
			ingresar_int(&forma_pago,1,4,"Ingrese el nuevo metodo de pago:\n1. Debito.\n2. Credito\n.3 Codigo QR\n4. Efectivo.", "Error. Metodo no valido.");
